...
},{"core-js/shim":"../../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../../node_modules/core-js/fn/regexp/escape.js"}],"alert.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Log out fail!');
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","babel-polyfill":"../../node_modules/babel-polyfill/lib/index.js","./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaG9hbmcxNDgyMDAyIiwiYSI6ImNrczZ3azR0YTBncDQyb3BscHZhNWN5ZnUifQ.4UlAU0JAnZfkQHHmfn9Ybg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type === 'password' ? 'Password' : 'Data', " updated!"));
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
...
var bookBtn = document.getElementById('bookId'); // delegation
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSetting.updateSettings)(form);
  });
}

if (userPasswordUpdateForm) {
  userPasswordUpdateForm.addEventListener('submit', function (e) {
    e.preventDefault();
